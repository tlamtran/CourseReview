...
app.post("/reviews", (req, res) => {
  ...
  const { review, course_id, likes, dislikes, difficulty, workload, teaching } = req.body;
  client.query(
    "INSERT INTO reviews (id, review, course_id, likes, dislikes, difficulty, workload, teaching) VALUES($1,$2,$3,$4,$5,$6,$7,$8) RETURNING *",
